    ...
    <main className="flex min-h-screen items-center justify-center px-6 py-32">
      <div className="max-w-3xl text-center">
        <div className="mx-auto flex h-24 w-24 items-center justify-center rounded-full bg-[#b0060d]/10">
          <FaTools className="text-4xl text-[#b0060d]" />
        </div>

        <h1 className="mt-8 text-5xl font-bold">Blog Coming Soon</h1>

        <p className="mt-6 text-lg opacity-80">
          We're preparing valuable automotive tips, maintenance guides,
          diagnostics advice, and vehicle upgrade articles. Check back soon for
          expert content from Favouritech Auto Concepts.
        </p>
