...
import { serviceProjectsQuery } from "@/lib/qurries";
...
export default async function ServiceProjects({ slug }: Props) {
  const projects = await client.fetch(serviceProjectsQuery, { slug });

  if (!projects.length) return null;

  return (
    <section className="mt-24">
      <h2 className="mb-10 text-3xl font-bold">Projects Completed</h2>
